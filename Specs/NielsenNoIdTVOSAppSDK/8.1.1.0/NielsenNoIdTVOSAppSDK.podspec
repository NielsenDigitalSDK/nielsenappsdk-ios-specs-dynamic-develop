Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/patch/tvOS/GlobalNoId/NielsenNoIdTVOSAppSDK-8.1.1.0.zip' }
