Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/master/tvOS/AGFNoAd/NielsenAGFNoAdTVOSAppSDK-7.2.0.0.zip' }
