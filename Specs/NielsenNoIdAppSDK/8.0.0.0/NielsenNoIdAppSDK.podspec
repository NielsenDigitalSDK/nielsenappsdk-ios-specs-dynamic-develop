Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/master/iOS/GlobalNoId/NielsenNoIdAppSDK-8.0.0.0.zip' }
